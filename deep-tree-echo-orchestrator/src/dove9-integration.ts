...
class Dove9SystemImpl extends EventEmitter {
  ...
  private config: { stepDuration: number; maxConcurrentProcesses: number; enableParallelCognition: boolean }
  ...
  constructor(
    ...
    config: { stepDuration: number; maxConcurrentProcesses: number; enableParallelCognition: boolean }
  ) {
    super()
