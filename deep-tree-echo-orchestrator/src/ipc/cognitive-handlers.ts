...
// CognitiveOrchestrator interface (local stub)
interface CognitiveOrchestrator {
  process(input: any): Promise<any>;
  quickProcess?(input: any): Promise<any>;
  getState(): any;
  getEmotionalState?(): any;
  updateEmotionalState?(update: any): void;
  getHistory?(opts: any): any;
  exportConversation?(opts: any): any;
  importConversation?(opts: any): any;
  getStatistics?(): any;
  searchMemory?(query: any): any;
  storeMemory?(data: any): any;
  getContext?(query: any): any;
...
export function registerCognitiveHandlers(
   ...
   */
  ipcServer.registerHandler(
    'cognitive_update_emotional_state',
    async (
