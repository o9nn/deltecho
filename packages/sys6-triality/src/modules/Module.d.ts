 ...
 */
export type InitStrategy = 'zeros' | 'ones' | 'uniform' | 'normal' | 'xavier_uniform' | 'xavier_normal' | 'kaiming_uniform' | 'kaiming_normal';
/**
 ...
 */
export declare function createParameter(name: string, shape: number[], init?: InitStrategy, requiresGrad?: boolean): Parameter;
/**
