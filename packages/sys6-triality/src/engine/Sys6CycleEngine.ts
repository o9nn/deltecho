...
import { add, scale, cat, gelu, layerNorm, clone } from '../tensors/operations.js';
...
export class Sys6CycleEngine extends Module {
  ...
  private _executeStep(
    ...
    const stepProcessor = this.stepProcessors[phaseIdx][stageIdx].get(
      stepIdx
    ) as TriadicConvolution;
