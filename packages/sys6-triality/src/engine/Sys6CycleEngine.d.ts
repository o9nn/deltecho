 ...
 */
import { ShapedTensor, TetradicBundle, StreamState, StepAddress, DoubleStepDelayState, PhaseId, StageId } from '../tensors/index.js';
...
export declare class Sys6CycleEngine extends Module {
     ...
     */
    step(absoluteStep: number, currentState: ShapedTensor, streams: [StreamState, StreamState, StreamState], tetradic: TetradicBundle, telemetryHidden?: [ShapedTensor, ShapedTensor], dyadState?: ShapedTensor, triadState?: ShapedTensor): {
