/**
 * Logger utility for @deltecho/reasoning package
 * Provides consistent logging for AGI kernel and reasoning components
 */
...
class ReasoningLogger implements Logger {
  ...
  child(subContext: string): Logger {
    return new ReasoningLogger(`${this.context}:${subContext}`);
  }
}

export function getLogger(context: string): Logger {
  return new ReasoningLogger(context);
}
