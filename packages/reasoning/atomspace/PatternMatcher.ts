...
export class PatternMatcher {
   ...
   */
  private matchAtom(pattern: Pattern, atom: Atom, bindings: Map<string, Atom>): boolean {
    // Check type match
  ...
  private calculateSimilarity(atom1: Atom, atom2: Atom): number {
    ...
    const tvSim = 1 - Math.abs(atom1.truthValue.strength - atom2.truthValue.strength);
