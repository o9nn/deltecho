...
export type { KernelConfig, CognitiveProcess, KernelStats } from './core/InfernoKernel.js';

// AtomSpace - Hypergraph knowledge representation
export { AtomSpace } from './atomspace/AtomSpace.js';
export type { Atom, AtomType, TruthValue, AttentionValue } from './atomspace/AtomSpace.js';
...
export type { Program, MOSESConfig, FitnessFunction } from './reasoning/MOSES.js';
