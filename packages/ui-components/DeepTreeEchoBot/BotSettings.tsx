      ...
      try {
        ...
        const basicSettings = {
          ...
          useParallelProcessing:
            desktopSettings.deepTreeEchoBotUseParallelProcessing !== false, // Default to true
        }
  ...
  return (
    <div className='deep-tree-echo-settings'>
      ...
      <div className='setting-section'>
        ...
        <label className='setting-item'>
          <div className='setting-label'>Enable Echo as Main User</div>
          <input
            type='checkbox'
            checked={settings.enableAsMainUser || false}
            onChange={e => handleChange('enableAsMainUser', e.target.checked)}
            disabled={!settings.enabled}
          />
          <div className='setting-description'>
            Allow Deep Tree Echo to act as the primary user in conversations,
            sending messages automatically without manual approval
          </div>
        </label>
