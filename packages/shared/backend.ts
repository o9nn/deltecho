...
export const BackendRemote = {
  rpc: {
    ...
    getContact: (accountId: number, contactId: number) =>
      backendInstance.getContact(accountId, contactId),
    getContacts: (accountId: number) => backendInstance.getContacts(accountId),
    createChat: (accountId: number, contactId: number) =>
      backendInstance.createChat(accountId, contactId),
    deleteChat: (accountId: number, chatId: number) =>
      backendInstance.deleteChat(accountId, chatId),
