...
- [Binary Generation Workflows](./docs/BINARY_GENERATION.md)
...
# For browser version:
$ pnpm -w build:browser:robust  # Build browser version
$ pnpm -w package:browser      # Create distributable package
$ pnpm -w start:browser        # Start browser version
```
...
For browser version setup, see [`docs/BROWSER_VERSION.md`](docs/BROWSER_VERSION.md).
