...
export default function Settings({ onClose }: DialogProps) {
  ...
  return (
    <Dialog onClose={onClose} fixed width={400} dataTestid='settings-dialog'>
      {settingsMode === 'main' && (
        <>
          ...
          <DialogBody>
            ...
            <SettingsIconButton
              icon='palette'
              onClick={() => setSettingsMode('deep_tree_echo_hub')}
              dataTestid='open-deep-tree-echo-hub'
            >
              Deep Tree Echo Hub
            </SettingsIconButton>
            <SettingsIconButton
      ...
      {settingsMode === 'deep_tree_echo_hub' && (
        <>
          <DialogHeader
            title='Deep Tree Echo Hub'
            onClickBack={() => setSettingsMode('main')}
            onClose={onClose}
            dataTestid='settings-deep-tree-echo-hub'
          />
          <DialogBody>
