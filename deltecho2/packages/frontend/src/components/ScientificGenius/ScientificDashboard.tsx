...
type Props = {
  /**
   * Optional close handler. When provided a close button is rendered in the
   * header (used when the dashboard is shown as a full screen).
   */
  onClose?: () => void
}

export const ScientificDashboard: React.FC<Props> = ({ onClose }) => {
      ...
      <div className='dashboard-header'>
        ...
        {onClose && (
          <button
            ...
            onClick={onClose}
            aria-label='Close Scientific Cortex'
          >
            Close ✕
          </button>
        )}
